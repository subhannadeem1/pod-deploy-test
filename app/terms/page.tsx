      ...
      <section className={`flex flex-row container mx-auto  ${animation_one}`}>
        ...
        <div className="bg-white w-full  pt-4 rounded md:rounded-r-lg   text-black !important">
          ...
          <p className="px-2 mx-2 my-2 text-xs">
            ...
            access or otherwise use the Site or any information contained
            herein.
          </p>
          ...
          <p className="px-2 mx-2 my-2 text-xs">
            ...
            specific person. To the extent that any of the content published on
            the Site may be deemed to be investment advice or recommendations in
            connection with a particular security, such information is
          ...
          <p className="px-2 mx-2 my-2 text-xs">
            ...
            and are likely not to be current. As things change continuously,
            previously published information and data may not be current and
          ...
          <p className="px-2 mx-2 my-2 text-xs">
            ...
            recommendation for any security. You alone are solely responsible
          ...
          <p className="px-2 mx-2 my-2 text-xs">
            ...
            therein are the property of The Pod Transcripts and its third-party
            licensors or providers. You may access and use the Content, and
            download and/or print out copies of any content from the Site,
            solely for your personal, non-commercial use. If you download or
            ...
            acknowledge that you do not acquire any ownership rights by using
            the Site.
          </p>
          ...
          <p className="px-2 mx-2 my-2 text-xs">
            ...
            contribute to the democratization of digital information on the
            Internet. So our reproduction policy is as follows:
            <br />
            <br />
            <strong>
              You may quote any transcript on the condition that you attribute
              the transcript to The Pod Transcripts and either link to the
              original transcript or to www.thepodtranscripts.com.
            </strong>
          </p>
          ...
          <p className="px-2 mx-2 my-2 text-xs">
            ...
            websites or on our Site. Please read the terms of use and privacy
            policy of any such third party sites that you interact with before
            you engage in any activity. You are solely responsible and liable
            for your use of and linking to all third party sites. You
            acknowledge and agree that we shall not be held responsible for the
            legality, accuracy, or appropriateness of any Content, advertising,
            products, services, or information located on our Site or any other
            websites, nor for any loss or damages caused or alleged to have been
            caused by the use of or reliance on any such content. Similarly,
            while we do endeavor to facilitate the provision of quality Apps, we
            are not responsible for any loss or damages caused or alleged to
            have been caused by their use. You may link to any content on the
            Site.
          </p>
          ...
          <p className="px-2 mx-2 my-2 text-xs">
            ...
            system. The Pod Transcripts has the right in its sole discretion and
            without further notice to you, to monitor, censor, edit, move,
            delete, and/or remove any and all Content posted on its Site or any
            Content. Without limiting the foregoing, The Pod Transcripts has the
            right to delete any comment or Content that it believes, in its sole
