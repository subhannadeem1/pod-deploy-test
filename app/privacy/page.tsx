      ...
      <section className={`flex flex-row container mx-auto ${animation_one}`}>
        ...
        <div className="bg-white w-full lg:p-10 p-4  rounded md:rounded-r-lg  text-black !important">
          ...
          <p className=" my-2 text-xs">
            ...
            information is collected and used at the Site. This Privacy Policy
            forms part of the Terms of Use.
          </p>
          ...
          <p className=" my-2 text-xs">
            ...
            home. Currently, we do not require you to provide Personal
            Information in order to have access to the commentary or
          ...
          <p className=" my-2 text-xs">
            ...
            choose not to receive email from us. Furthermore, if you do not wish
            to receive email from us, you may unsubscribe from receiving further
            email from us.
          </p>
          ...
          <p className=" my-2 text-xs">
            ...
            Transcripts intends to adhere to the principles set forth in this
            Privacy Policy even if, in connection with the above, we transfer
            your Personal Information from your country to countries that may
            not require an “adequate” level of protection for your Personal
            Information. In other words, our goal is to provide protection for
            your Personal Information no matter where that Personal Information
          ...
          <p className=" my-2 text-xs">
            ...
            to track the pages that users visit during each Site session, both
            to help us improve users' experiences and to help us understand how
            the Site is being used. As with other non-Personal Information
            gathered from users of the Site, we analyze and disclose in
            aggregated form information gathered using Web Cookies, so as to
            help us, our partners and others better understand how the Site is
            being used. We do not attempt to link information gathered using Web
          ...
          <p className=" my-2 text-xs">
            ...
            NOT FUNCTION PROPERLY WITHOUT THE AID OF WEB COOKIES. USERS WHO
            REFUSE WEB COOKIES ASSUME ALL RESPONSIBILITY FOR ANY RESULTING LOSS
            OF FUNCTIONALITY.
          </p>
          ...
          <p className=" my-2 text-xs">
            ...
            use Web Beacons on the Site and in emails to count users who have
            visited particular pages, viewed emails, and to deliver co-branded
            services. Web Beacons are not used to access users' Personal
            Information; they are a technique we may use to compile aggregated
            statistics about Site usage. Web Beacons collect only a limited set
            of information including a Web Cookie number, time and date of a
            page or email view, and a description of the page or email on which
            the Web Beacon resides. You may not decline Web Beacons, however,
            they can be rendered ineffective by declining all Web Cookies or
            modifying your browser setting to notify you each time a Web Cookie
            is tendered and permit you to accept or decline Web Cookies on an
            individual basis.
          </p>
          ...
          <p className=" my-2 text-xs">
            ...
            including any Personal Information) about your visits to this and
            other websites that are contained in Web Cookies and Web Beacons in
            order to provide advertisements about goods and services of interest
            to you. The use of these technologies by these third party ad
            servers is subject to their own privacy policies and is not covered
            by our Privacy Policy. Using a tool created by the Network
            Advertising Initiative, you can opt out of several third party ad
            servers' and networks' Web Cookies simultaneously. If you would like
            more information about this practice and to know your choices about
            not having this information used by these companies, please follow
            the following link:
            http://networkadvertising.org/managing/opt_out.asp. Please contact
            us if you would like to know the identity of the third-party
          ...
          <p className=" my-2 text-xs">
            ...
            may have decided not to show to other users, such as your birth year
            or other sensitive personal information or preferences) to select
            the appropriate audience for those advertisements. We do not
          ...
          <p className=" my-2 text-xs">
            ...
            questions regarding our Privacy Policy, please contact us. While we
          ...
          <p className=" my-2 text-xs">
            ...
            Policy, please do not use our Site. We reserve the right, at our
            discretion, to change, modify, add, or remove portions from this
            Privacy Policy at any time. Your continued use of our Site following
            the posting of changes to these terms means you accept these
            changes.
          </p>
